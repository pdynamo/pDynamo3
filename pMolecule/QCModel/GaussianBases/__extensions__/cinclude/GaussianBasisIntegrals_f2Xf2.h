# ifndef _GAUSSIANBASISINTEGRALS_F2XF2
# define _GAUSSIANBASISINTEGRALS_F2XF2
...
! . Procedures.
!---------------------------------------------------------------------------------------------------------------------------------*/
extern void GaussianBasisIntegrals_f2Af2i  ( const GaussianBasis *iBasis     ,
                                             const Real          *rI         ,
...
extern void GaussianBasisIntegrals_f2Cf2r1 ( const GaussianBasis *iBasis     ,
                                             ...
                                             const Integer        s4         ,
                                                   ...
                                                   Real          *rWork      ,
                                                   Block         *block      ) ;
extern void GaussianBasisIntegrals_f2Of2i  ( const GaussianBasis *iBasis     ,
                                             const Real          *rI         ,
                                             const GaussianBasis *jBasis     ,
                                             const Real          *rJ         ,
                                             const GaussianBasis *kBasis     ,
