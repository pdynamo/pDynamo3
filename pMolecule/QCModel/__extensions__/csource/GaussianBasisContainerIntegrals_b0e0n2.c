...
# include "GaussianBasisContainerIntegrals_b0e0n2.h"
...
!---------------------------------------------------------------------------------------------------------------------------------*/
Real GaussianBasisContainer_NuclearNuclearEnergy ( const RealArray1D  *chargesI      ,
...
!---------------------------------------------------------------------------------------------------------------------------------*/
void GaussianBasisContainer_NuclearNuclearPotentials ( const RealArray1D  *chargesJ      ,
                                                       const Coordinates3 *coordinates3I ,
                                                       const Coordinates3 *coordinates3J ,
                                                             Selection    *selectionI    ,
                                                             Selection    *selectionJ    ,
