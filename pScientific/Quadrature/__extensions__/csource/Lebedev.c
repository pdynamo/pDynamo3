...
!---------------------------------------------------------------------------------------------------------------------------------*/
Integer  LebedevLaikov_Angular_Momentum_Value ( const Integer  numberOfPoints )
{
    Integer  lValue = 0;
         if ( numberOfPoints <=    6 ) lValue =   3 ;
    else if ( numberOfPoints <=   14 ) lValue =   5 ;
    else if ( numberOfPoints <=   26 ) lValue =   7 ;
    else if ( numberOfPoints <=   38 ) lValue =   9 ;
    else if ( numberOfPoints <=   50 ) lValue =  11 ;
    else if ( numberOfPoints <=   74 ) lValue =  13 ;
    else if ( numberOfPoints <=   86 ) lValue =  15 ;
    else if ( numberOfPoints <=  110 ) lValue =  17 ;
    else if ( numberOfPoints <=  146 ) lValue =  19 ;
    else if ( numberOfPoints <=  170 ) lValue =  21 ;
    else if ( numberOfPoints <=  194 ) lValue =  23 ;
    else if ( numberOfPoints <=  230 ) lValue =  25 ;
    else if ( numberOfPoints <=  266 ) lValue =  27 ;
    else if ( numberOfPoints <=  302 ) lValue =  29 ;
    else if ( numberOfPoints <=  350 ) lValue =  31 ;
    else if ( numberOfPoints <=  434 ) lValue =  35 ;
    else if ( numberOfPoints <=  590 ) lValue =  41 ;
    else if ( numberOfPoints <=  770 ) lValue =  47 ;
    else if ( numberOfPoints <=  974 ) lValue =  53 ;
    else if ( numberOfPoints <= 1202 ) lValue =  59 ;
    else if ( numberOfPoints <= 1454 ) lValue =  65 ;
    else if ( numberOfPoints <= 1730 ) lValue =  71 ;
    else if ( numberOfPoints <= 2030 ) lValue =  77 ;
    else if ( numberOfPoints <= 2354 ) lValue =  83 ;
    else if ( numberOfPoints <= 2702 ) lValue =  89 ;
    else if ( numberOfPoints <= 3074 ) lValue =  95 ;
    else if ( numberOfPoints <= 3470 ) lValue = 101 ;
    else if ( numberOfPoints <= 3890 ) lValue = 107 ;
    else if ( numberOfPoints <= 4334 ) lValue = 113 ;
    else if ( numberOfPoints <= 4802 ) lValue = 119 ;
    else if ( numberOfPoints <= 5294 ) lValue = 125 ;
    else if ( numberOfPoints <= 5810 ) lValue = 131 ;
    return lValue ;
}
...
! . The value is rounded down.
!---------------------------------------------------------------------------------------------------------------------------------*/
void LebedevLaikov_GridPointsWeights ( const Integer  numberOfPoints, Coordinates3 *gridPoints, RealArray1D *weights )
{
    if ( ( numberOfPoints > 0 ) && ( gridPoints != NULL ) && ( weights != NULL ) )
    {
        auto Integer  i ;
        auto Real    *w, *x, *y, *z ;
        /* . Allocate space. */
        x = Memory_AllocateArrayOfTypes ( numberOfPoints, Real ) ;
        y = Memory_AllocateArrayOfTypes ( numberOfPoints, Real ) ;
        z = Memory_AllocateArrayOfTypes ( numberOfPoints, Real ) ;
        w = Memory_AllocateArrayOfTypes ( numberOfPoints, Real ) ;
        /* . Get the grid points and weights. */
        LebedevLaikov_Points ( numberOfPoints, x, y, z, w ) ;
        /* . Fill final arrays. */
        for ( i = 0 ; i < numberOfPoints ; i++ )
        {
            Coordinates3_SetRow ( gridPoints, i, x[i], y[i], z[i] ) ;
            Array1D_Item ( weights, i ) = w[i] ;
        }
        /* . Deallocate space. */
        Memory_Deallocate ( x ) ;
        Memory_Deallocate ( y ) ;
...
!---------------------------------------------------------------------------------------------------------------------------------*/
Integer  LebedevLaikov_Number_Of_Points ( const Integer  lValue )
{
  Integer  fraction, numberOfPoints = 0, tmp_lValue ;
  tmp_lValue = lValue ;
  if ( lValue < 3 ) numberOfPoints = 6 ; /* . Small grids.*/
  else if ( lValue <= 31 )               /* . Grids complete through l = 2m+1. */
  {
      ...
      switch ( tmp_lValue )
      {
         case  0: numberOfPoints =   6 ; break ;
         case  1: numberOfPoints =   6 ; break ;
         case  2: numberOfPoints =  14 ; break ;
         case  3: numberOfPoints =  26 ; break ;
         case  4: numberOfPoints =  38 ; break ;
         case  5: numberOfPoints =  50 ; break ;
         case  6: numberOfPoints =  74 ; break ;
         case  7: numberOfPoints =  86 ; break ;
         case  8: numberOfPoints = 110 ; break ;
         case  9: numberOfPoints = 146 ; break ;
         case 10: numberOfPoints = 170 ; break ;
         case 11: numberOfPoints = 194 ; break ;
         case 12: numberOfPoints = 230 ; break ;
         case 13: numberOfPoints = 266 ; break ;
         case 14: numberOfPoints = 302 ; break ;
         case 15: numberOfPoints = 350 ; break ;
      }
   }
   else if ( lValue <= 131 ) /* . Grids complete through l = 6m+5. */
   {
      ...
      switch ( tmp_lValue )
      {
         case  5: numberOfPoints =  434 ; break ;
         case  6: numberOfPoints =  590 ; break ;
         case  7: numberOfPoints =  770 ; break ;
         case  8: numberOfPoints =  974 ; break ;
         case  9: numberOfPoints = 1202 ; break ;
         case 10: numberOfPoints = 1454 ; break ;
         case 11: numberOfPoints = 1730 ; break ;
         case 12: numberOfPoints = 2030 ; break ;
         case 13: numberOfPoints = 2354 ; break ;
         case 14: numberOfPoints = 2702 ; break ;
         case 15: numberOfPoints = 3074 ; break ;
         case 16: numberOfPoints = 3470 ; break ;
         case 17: numberOfPoints = 3890 ; break ;
         case 18: numberOfPoints = 4334 ; break ;
         case 19: numberOfPoints = 4802 ; break ;
         case 20: numberOfPoints = 5294 ; break ;
         case 21: numberOfPoints = 5810 ; break ;
      }
   }
...
Integer  LebedevLaikov_Points ( const Integer  N, Real* X, Real* Y, Real* Z, Real* W )
{
  Integer  n;
  n = 0;
  switch ( N ) {
